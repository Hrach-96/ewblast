        ...
        <form action='{{route('admin.news.edit',['id'=>$news->id])}}' enctype="multipart/form-data" method='post' >
            ...
            <div class='row'>
                ...
                <div class='col-6'>
                    ...
                    <textarea name='content_am' class='form-control editorTextarea'>{{$news->content_am}}</textarea>
                </div>
                <div class='col-6'>
                    <label for='content_en'>Content En</label>
                    <textarea name='content_en' class='form-control editorTextarea'>{{$news->content_en}}</textarea>
                </div>
